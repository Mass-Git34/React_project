    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <div className="flex flex-row gap-4">
          ...
          <div class="bg-white-100 p-6 min-h-screen basis-1/2">
            <div className="bg-white shadow-md rounded-lg p-5">
              {/* Documentation Banner */}
              <div className="bg-blue-100 p-4 rounded-lg shadow-sm text-center">
                <p className="text-blue-700 font-medium">
                  Read our documentation with{" "}
                  <span className="font-bold">code samples</span>.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-6">
                ...
                {/* First Pie Chart */}
                <div className="w-80 h-80 bg-white shadow-md rounded-lg p-4 flex flex-col items-center justify-center">
                  ...
                  <div className="relative w-40 h-40">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "conic-gradient(#22c55e 0% 37%, #ffffff00 37% 100%)",
                      }}
                    ></div>
                    {/* Inner Circle */}
                    <div className="absolute top-4 left-4 w-32 h-32 rounded-full bg-white"></div>
                    {/* Labels */}
                    <div className="absolute text-sm font-bold text-center top-16 left-6">
                      <p>37%</p>
                      <p className="text-gray-500 text-xs">Green</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-80 h-80 bg-white shadow-md rounded-lg p-4 flex flex-col items-center justify-center">
                  ...
                  <div className="relative w-40 h-40">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "conic-gradient(#22c55e 0% 37%,rgba(255, 255, 255, 0) 37% 100%)",
                      }}
                    ></div>
                    {/* Inner Circle */}
                    <div className="absolute top-4 left-4 w-32 h-32 rounded-full bg-white"></div>
